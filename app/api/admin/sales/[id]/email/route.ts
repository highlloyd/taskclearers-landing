...
export async function POST(request: Request, context: Context) {
  ...
  try {
    ...
    const { templateId, subject, body: emailBody, recipientEmail, from, fromName } = body;
    ...
    const toEmail = recipientEmail || lead.contactEmail;

    // Replace placeholders in subject and body
    const contactFirst = lead.contactName.split(' ')[0] || lead.contactName;
